...
wxFont LoadFontFromMemory() {
  wxFont font(22, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL,
              false, "Font Awesome 6 Free Solid");
  return font;
}
...
const wxString labels[] = {wxT("Add"),     wxT("Search"),  wxT("Patient"),
                           wxT("Reports"), wxT("Drugs"),   wxT("Agenda"),
                           wxT("Income"),  wxT("Settings")};
